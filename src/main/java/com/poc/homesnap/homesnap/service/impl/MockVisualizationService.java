...
import com.poc.homesnap.homesnap.model.rhino.MeshResponse;
import com.poc.homesnap.homesnap.model.rhino.MeshResponse.MeshData;
...
public class MockVisualizationService implements VisualizationService {
    ...
    @Override
    public boolean canGenerateMoreVisualizations(Long userId) {
        ...
        return switch (user.getRole()) {
            case FREE -> currentPlanCount < 3;
            case REGISTERED -> currentPlanCount < 5;
